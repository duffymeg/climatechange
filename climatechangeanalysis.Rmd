...
preCCHappeningcombined <- aggregate(data.frame(count = cctookbothcombined$CC_Happening_pre), list(value = cctookbothcombined$CC_Happening_pre), length)

postCCHappeningcombined <- aggregate(data.frame(count = cctookbothcombined$CC_Happening_post), list(value = cctookbothcombined$CC_Happening_post), length)

preCCHappeningcombined$prepost <- rep("pre",nrow(preCCHappeningcombined))
postCCHappeningcombined$prepost <- rep("post",nrow(postCCHappeningcombined))
...
CCHappeningPrePostPlotGridcombined <- ggplot(CCHappeningDataBindcombined, aes(x=Answer)) +
    geom_bar(position="identity") +
  facet_wrap(~prepost, nrow = 2) +
  ggtitle("Do you think climate change is happening?") +
  theme_bw() +
...
CCHappeningPrePostPlotGridcombined

save_plot("CCHappeningPrePostPlotGridcombined.jpg", CCHappeningPrePostPlotGridcombined, base_width = 10, base_height = 4)

CCHappeningPrePostPlotSideBySidecombined <- ggplot(CCHappeningDataBindcombined, aes(x=Answer,fill=prepost)) +
    geom_bar(position = position_dodge2(preserve="single")) +
  theme_bw()

CCHappeningPrePostPlotSideBySidecombined
```
...
CCHappeningDataBindcombined$prepost <- plyr::mapvalues(CCHappeningDataBindcombined$prepost , from = c("pre", "post"), to = c("Beginning","End"))

CCHappeningDataBindcombined$prepost <- factor(CCHappeningDataBindcombined$prepost, c("End","Beginning"))
...
save_plot("cchappeninglikertplotcombined.jpg", cchappeninglikertplotcombined, base_width = 12, base_height = 5)
```
...
## Reaction norm plots
```{r, did individual views on whether climate change is happening change during semester?}
cchappeningwidecombined <- dplyr::select(cctookbothcombined, CC_Happening_pre, CC_Happening_post)

cchappeningwidecombined$ID <- seq.int(nrow(cchappeningwidecombined))

cchappeninglongcombined <- cchappeningwidecombined %>%
#  filter(CC_Happening_pre != "NA" & CC_Happening_post != "NA" ) %>%
  gather(PrevPost,CCHappening,CC_Happening_pre:CC_Happening_post)

cchappeninglongcombined$CCHappening01 <-  plyr::mapvalues(cchappeninglongcombined$CCHappening, from = c("NoExtrSure", "NoVerySure","NoSomeSure","NoNotSure","DK","YesNotSure","YesSomeSure","YesVerySure","YesExtrSure"), to = c(1,2,3,4,5,6,7,8,9))

cchappeninglongcombined$CCHappening01 <- as.numeric(as.character(cchappeninglongcombined$CCHappening01))

cchappeninglongcombined$PrevPost <- plyr::mapvalues(cchappeninglongcombined$PrevPost, from = c("CC_Happening_pre","CC_Happening_post"), to = c("beginning", "end"))

cchappeninglongcombined$PrevPost <- factor(cchappeninglongcombined$PrevPost, levels=c("beginning", "end"))

cchappeningrxnplotcombined <- cchappeninglongcombined %>%
  ggplot(aes(x=PrevPost, y=CCHappening01, group=ID)) +
  geom_line(position=position_jitter(w=0.02, h=0.02),alpha=0.3) +
  ggtitle("Paired responses") +
  theme(plot.title = element_text(hjust = 0.5)) +
...
cchappeningrxnplotcombined


save_plot("cchappeningrxnplotcombined.jpg", cchappeningrxnplotcombined, base_width = 6, base_height = 4)
```
...
preCCConsensusCausecombined <- aggregate(data.frame(count = cctookbothcombined$CC_ConsensusCause_pre), list(value = cctookbothcombined$CC_ConsensusCause_pre), length)

postCCConsensusCausecombined <- aggregate(data.frame(count = cctookbothcombined$CC_ConsensusCause_post), list(value = cctookbothcombined$CC_ConsensusCause_post), length)

preCCConsensusCausecombined$prepost <- rep("pre",nrow(preCCConsensusCausecombined))
postCCConsensusCausecombined$prepost <- rep("post",nrow(postCCConsensusCausecombined))
...
CCConsensusCausePrePostPlotGridcombined <- ggplot(CCConsensusCauseDataBindcombined, aes(x=Answer)) +
    geom_bar(position="identity") +
  facet_wrap(~prepost, nrow = 2) +
  ggtitle("Which of the following best describes the scientific consensus regarding the cause of climate change?") +
  theme_bw() +
...
CCConsensusCausePrePostPlotGridcombined

save_plot("CCConsensusCausePrePostPlotGridcombined.jpg", CCConsensusCausePrePostPlotGridcombined, base_width = 10, base_height = 4)
...
CCConsensusCauseDataBindAllcombined$prepost <- plyr::mapvalues(CCConsensusCauseDataBindAllcombined$prepost , from = c("pre", "post"), to = c("Beginning","End"))
...
preCCScientistsWhethercombined <- aggregate(data.frame(count = cctookbothcombined$CC_ScientistsWhether_pre), list(value = cctookbothcombined$CC_ScientistsWhether_pre), length)

postCCScientistsWhethercombined <- aggregate(data.frame(count = cctookbothcombined$CC_ScientistsWhether_post), list(value = cctookbothcombined$CC_ScientistsWhether_post), length)

preCCScientistsWhethercombined$prepost <- rep("pre",nrow(preCCScientistsWhethercombined))
postCCScientistsWhethercombined$prepost <- rep("post",nrow(postCCScientistsWhethercombined))
...
CCScientistsWhetherPrePostPlotGridcombined <- ggplot(CCScientistsWhetherDataBindcombined, aes(x=Answer)) +
    geom_bar(position="identity") +
  facet_wrap(~prepost, nrow = 2) +
  ggtitle("How much do you agree that scientists have a good understanding of whether CC is occurring?") +
  theme_bw() +
...
CCScientistsWhetherPrePostPlotGridcombined

save_plot("CCScientistsWhetherPrePostPlotGridcombined.jpg", CCScientistsWhetherPrePostPlotGridcombined, base_width = 10, base_height = 4)
```
...
CCScientistsWhetherDataBindNoDKcombined$prepost <- plyr::mapvalues(CCScientistsWhetherDataBindNoDKcombined$prepost , from = c("pre", "post"), to = c("Beginning","End"))

CCScientistsWhetherDataBindNoDKcombined$prepost <- factor(CCScientistsWhetherDataBindNoDKcombined$prepost, c("End","Beginning"))
...
preCCScientistsWhycombined <- aggregate(data.frame(count = cctookbothcombined$CC_ScientistsWhy_pre), list(value = cctookbothcombined$CC_ScientistsWhy_pre), length)

postCCScientistsWhycombined <- aggregate(data.frame(count = cctookbothcombined$CC_ScientistsWhy_post), list(value = cctookbothcombined$CC_ScientistsWhy_post), length)

preCCScientistsWhycombined$prepost <- rep("pre",nrow(preCCScientistsWhycombined))
postCCScientistsWhycombined$prepost <- rep("post",nrow(postCCScientistsWhycombined))
...
CCScientistsWhyPrePostPlotGridcombined <- ggplot(CCScientistsWhyDataBindcombined, aes(x=Answer)) +
    geom_bar(position="identity") +
  facet_wrap(~prepost, nrow = 2) +
  ggtitle("How much do you agree that scientists have a good understanding of why CC is occurring?") +
  theme_bw() +
...
CCScientistsWhyPrePostPlotGridcombined

save_plot("CCScientistsWhyPrePostPlotGridcombined.jpg", CCScientistsWhyPrePostPlotGridcombined, base_width = 10, base_height = 4)
```
...
CCScientistsWhyDataBindNoDKcombined$prepost <- plyr::mapvalues(CCScientistsWhyDataBindNoDKcombined$prepost , from = c("pre", "post"), to = c("Beginning","End"))

CCScientistsWhyDataBindNoDKcombined$prepost <- factor(CCScientistsWhyDataBindNoDKcombined$prepost, c("End","Beginning"))
...
save_plot("combinedccwhetherwhyplotcombined.jpg", combinedccwhetherwhyplotcombined, base_width = 10, base_height = 8)
```


## Do students feel that the course changed how they think about climate change?

```{r, course changed views for combined data}
postCCChangedMecombined <- aggregate(data.frame(count = cctookbothcombined$CC_ChangedMe_post), list(value = cctookbothcombined$CC_ChangedMe_post), length)

postCCChangedMecombined$prepost <- rep("post",nrow(postCCChangedMecombined))

CCChangedMePostcombined <- cctookbothcombined$CC_ChangedMe_post
CCChangedMePostcombined <- as.data.frame(CCChangedMePostcombined)
names(CCChangedMePostcombined)[1] = c("Answer")

CCChangedMePostcombined$prepost <- rep("post",nrow(CCChangedMePostcombined))

CCChangedMePostcombined$Answer <- factor(CCChangedMePostcombined$Answer, 
                                            c("StronglyAgree",
                                              "SomewhatAgree",
                                              "Neither",
                                              "SomewhatDisagree",
...
CCChangedMePlotcombined <- ggplot(CCChangedMePostcombined, aes(x=Answer)) +
    geom_bar(position="identity") +
  ggtitle("This course changed how I think about climate change") +
  theme_bw() +
  ylab("Number of responses")

CCChangedMePlotcombined

save_plot("CCChangedMePlotcombined.jpg", CCChangedMePlotcombined, base_width = 10, base_height = 3)
```


```{r, making Likert style plot on changing views data for combined data}
ccchangedmeresponsescombined <- CCChangedMePostcombined %>%
  select(Answer)

CCChangedMePostcombined$prepost <- plyr::mapvalues(CCChangedMePostcombined$prepost , from = c("post"), to = c("end"))

# rename and order the responses
ccchangedmeresponsescombined$Answer <- plyr::mapvalues(ccchangedmeresponsescombined$Answer, from = c("StronglyAgree","SomewhatAgree","Neither","SomewhatDisagree","StronglyDisagree"), to = c("Strongly Agree", "Somewhat Agree", "Neither", "Somewhat Disagree", "Strongly Disagree"))

ccchangedmeresponsescombined$Answer <- factor(ccchangedmeresponsescombined$Answer, 
                                 c("Strongly Disagree",
                                   "Somewhat Disagree",
                                    "Neither",
                                    "Somewhat Agree",
...
colnames(ccchangedmeresponsescombined)[1] <- "end"
likert_ccchangedmecombined <- likert(ccchangedmeresponsescombined)


ccchangedmelikertplotcombined = plot(likert_ccchangedmecombined,legend.position="bottom",text.size=5) + 
  scale_y_continuous(limits=c(-100,150)) +
  coord_flip(ylim=c(-110,110)) +
  theme(strip.text = element_text(margin=margin(4, 0, 4, 0))) +
 ggtitle("This course changed how I think about climate change")  +
...
ccchangedmelikertplotcombined <- ggplot_gtable(ggplot_build(ccchangedmelikertplotcombined))
ccchangedmelikertplotcombined$layout$clip <- "off"
ccchangedmelikertplotcombined.mpg <- plot(ccchangedmelikertplotcombined)

plot(ccchangedmelikertplotcombined) 

save_plot("ccchangedmelikertplotcombined.jpg", ccchangedmelikertplotcombined, base_width = 10, base_height = 3)
```
...
preCCThoughtcombined <- aggregate(data.frame(count = cctookbothcombined$CC_Thought_pre), list(value = cctookbothcombined$CC_Thought_pre), length)

postCCThoughtcombined <- aggregate(data.frame(count = cctookbothcombined$CC_Thought_post), list(value = cctookbothcombined$CC_Thought_post), length)

preCCThoughtcombined$prepost <- rep("pre",nrow(preCCThoughtcombined))
postCCThoughtcombined$prepost <- rep("post",nrow(postCCThoughtcombined))
...
CCThoughtPrePostPlotGridcombined <- ggplot(CCThoughtDataBindcombined, aes(x=Answer)) +
    geom_bar(position="identity") +
  facet_wrap(~prepost, nrow = 2) +
  ggtitle("How much had you thought about climate change before this course?") +
  theme_bw() +
...
CCThoughtPrePostPlotGridcombined

save_plot("CCThoughtPrePostPlotGridcombined.jpg", CCThoughtPrePostPlotGridcombined, base_width = 10, base_height = 4)
```
...
CCThoughtDataBindSubsetcombined$prepost <- plyr::mapvalues(CCThoughtDataBindSubsetcombined$prepost , from = c("pre", "post"), to = c("beginning","end"))

CCThoughtDataBindSubsetcombined$prepost <- factor(CCThoughtDataBindSubsetcombined$prepost, c("end","beginning"))
...
save_plot("ccthoughtlikertplotcombined.jpg", ccthoughtlikertplotcombined, base_width = 12, base_height = 5)
...
preCCWorriedcombined <- aggregate(data.frame(count = cctookbothcombined$CC_Worried_pre), list(value = cctookbothcombined$CC_Worried_pre), length)

postCCWorriedcombined <- aggregate(data.frame(count = cctookbothcombined$CC_Worried_post), list(value = cctookbothcombined$CC_Worried_post), length)

preCCWorriedcombined$prepost <- rep("pre",nrow(preCCWorriedcombined))
postCCWorriedcombined$prepost <- rep("post",nrow(postCCWorriedcombined))
...
CCWorriedPrePostPlotGridcombined <- ggplot(CCWorriedDataBindcombined, aes(x=Answer)) +
    geom_bar(position="identity") +
  facet_wrap(~prepost, nrow = 2) +
  ggtitle("How worried are you about climate change?") +
  theme_bw() +
...
CCWorriedPrePostPlotGridcombined

save_plot("CCWorriedPrePostPlotGridcombined.jpg", CCWorriedPrePostPlotGridcombined, base_width = 10, base_height = 4)
```
...
CCWorriedDataBindSubsetcombined$prepost <- plyr::mapvalues(CCWorriedDataBindSubsetcombined$prepost , from = c("pre", "post"), to = c("beginning","end"))

CCWorriedDataBindSubsetcombined$prepost <- factor(CCWorriedDataBindSubsetcombined$prepost, c("end","beginning"))
...
save_plot("ccworriedlikertplotcombined.jpg", ccworriedlikertplotcombined, base_width = 12, base_height = 5)
