...
ccbeliefsstackedbarplot <- ggplot(CCbeliefssummaryall, aes(y=rel.freq, x=prepost)) + 
  ...
  ggtitle("Which best captures your beliefs about the cause(s) of climate change?")
  

  ccbeliefsstackedbarplot

save_plot("ccbeliefsstackedbarplot.jpg", ccbeliefsstackedbarplot, base_width = 10, base_height = 5)
...
ccconsensuscausestackedbarplot <- ggplot(CCconsensuscausesummaryall, aes(y=rel.freq, x=prepost)) + 
  ...
  xlab("Time of survey") +
  scale_fill_manual(values=c("gray","#8c510a","#d8b365","#f6e8c3","#ABD9D5","#01665e")) +
  ggtitle("What is the scientific consensus regarding the cause(s) of climate change?")
  

ccconsensuscausestackedbarplot

save_plot("ccconsensuscausestackedbarplot.jpg", ccconsensuscausestackedbarplot, base_width = 10, base_height = 5)
...
save_plot("ccconsensuscausestackedbarplotw18.jpg", ccconsensuscausestackedbarplotw18, base_width = 10, base_height = 5)
...
likert_ccscientistswhetherw18 <- likert(ccscientistswhetherresponsesw18, grouping = ccscientistswhetherresponses_groupingw18$prepost)
